# ---/// Reduced Row Echelon Form (RREF) Step-by-Step Explainer ///---

import numpy as np

print("Let's reduce a matrix to Reduced Row Echelon Form (RREF) step by step!\n")
...
print("\nStep 1: Apply Gauss-Jordan elimination to get RREF.")
mat = A.copy()
rows, cols = mat.shape
lead = 0
for r in range(rows):
